describe('NGO LogIn with email ', () => {
    it('NGO LogIn with correct Mobile number', () => {
      ...
      cy.wait(1000)
      cy.get("[id='email_error']").contains('Email Id is required')
      cy.get("[placeholder='Your Email Address']").click().type("j.koti1995@gmail.com")
    ...
    it('NGO LogIn with in-correct email', () => {
      //cy.visit("https://qause-phi.vercel.app/")
      ...
      cy.get("[placeholder='Your Email Address']").click().type("j.00koti1995@gmail.com")
  
      cy.contains("Request OTP").click({force: true})
      cy.wait(1000)
      cy.get("[id='email_error']").contains("Email Id doesn't exists.")
      cy.wait(10000)
  
    })

    it('NGO LogIn with in-valid email', () => {
      //cy.visit("https://qause-phi.vercel.app/")
      ...
      cy.get("[placeholder='Your Email Address']").click().type("j.00koti199")
  
      cy.contains("Request OTP").click({force: true})
      cy.wait(1000)
      cy.get("[id='email_error']").contains('Email Id is invalid')
      cy.wait(10000)
    ...
    it('NGO LogIn with correct Email with invalid otp', () => {
      //cy.visit("https://qause-phi.vercel.app/")
